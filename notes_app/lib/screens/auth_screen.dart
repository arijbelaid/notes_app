  ...
  Future<void> _submitForm() async {
    ...
    try {
      if (_isLogin) {
        ...
        success = await authProvider.register(_emailController.text.trim(), _passwordController.text, _nameController.text.trim());
      }
          ...
          child: SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  Text(_isLogin ? 'Login' : 'Register', style: Theme.of(context).textTheme.headlineMedium, textAlign: TextAlign.center),
